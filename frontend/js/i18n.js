...
const translations = {
  ar: {
    ...
    ai_providers_intro: 'أضف مفاتيح من مزوّدين مجانيين وأقوياء تُستخدم كبديل تلقائي للمساعد الدوائي (بحث الأدوية) عند نفاد رصيد Gemini. لكل مزوّد ١٠ خانات. (المسح بالصورة والنشرات يبقى على Gemini.)',
    ...
    assistant_active_ingredient: 'المادة الفعّالة',
    assistant_uses: 'دواعي الاستعمال',
    assistant_dosage: 'الجرعة المعتادة',
    assistant_warnings: 'تحذيرات واحتياطات',
    assistant_contraindications: 'موانع الاستعمال',
    assistant_scan_info_title: 'معلومات الدواء (بالذكاء الاصطناعي)',
    assistant_scan_info_loading: 'جاري جلب معلومات الدواء...',
  ...
  en: {
    ...
    ai_providers_intro: 'Add keys from free, strong providers used as automatic fallback for the drug assistant (search) when Gemini runs out. Each provider has 10 slots. (Photo scan & leaflets stay on Gemini.)',
    ...
    assistant_active_ingredient: 'Active Ingredient',
    assistant_uses: 'Uses',
    assistant_dosage: 'Usual Dosage',
    assistant_warnings: 'Warnings & Precautions',
    assistant_contraindications: 'Contraindications',
    assistant_scan_info_title: 'Drug info (AI-powered)',
    assistant_scan_info_loading: 'Fetching drug info...',
